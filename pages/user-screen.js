...
const UserScreen = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[3769px] overflow-hidden text-left text-5xl text-white font-inter">
      ...
      />
      <div className="absolute top-[682px] left-[129px] rounded-2xl bg-gray-400 box-border w-[260px] h-[206px] border-[1px] border-solid border-white" />
      ...
      />
      <div className="absolute top-[123px] left-[1295px] rounded-[20px] bg-black box-border w-[188px] h-[97px] border-[1px] border-solid border-orange" />
      <div className="absolute top-[134px] left-[1308px] text-mini inline-block w-[92px] h-5">
        Profile
      </div>
      <div className="absolute top-[161px] left-[1308px] text-mini inline-block w-[141px] h-5">
        Personality Test
      </div>
      <div className="absolute top-[188px] left-[1308px] text-mini inline-block w-[141px] h-5">
        Sign out
      </div>
      <div className="absolute top-[153.5px] left-[1306.5px] box-border w-[168px] h-px border-t-[1px] border-solid border-orange" />
      <div className="absolute top-[184.5px] left-[1306.5px] box-border w-[168px] h-px border-t-[1px] border-solid border-orange" />
    </div>
  );
};
